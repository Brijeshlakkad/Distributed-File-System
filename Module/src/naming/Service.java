...
public interface Service extends Remote {
     ...
     * @throws FileNotFoundException If the given path does not refer to a directory.
     * @throws RMIException          If the call cannot be completed due to a network error.
     */
     ...
     * deleted.
     * @throws FileNotFoundException If the object or parent directory does not exist.
     * @throws RMIException          If the call cannot be completed due to a network error.
     */
