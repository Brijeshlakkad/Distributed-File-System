 ...
 *
 * <p>
 * naming server performs the following checks each time a storage server sters:
 * <ul>
...
class TestNamingServer implements naming.Registration {
     ...
     *
     * @param files The files to expect. The naming server will check that these are indeed the files that are received.
     *              If this argument is <code>null</code>, the naming server will not perform the check.
     */
