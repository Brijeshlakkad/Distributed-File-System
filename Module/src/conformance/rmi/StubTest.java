 ...
 *
 * <p>
 * e tests are best performed after <code>SkeletonTest</code>.
 *
 * <p>
 * tests performed are:
 * <ul>
...
public class StubTest extends Test {
     ...
     *
     * @throws TestFailed If a <code>Stub</code> is created from a class, or if an unexpected exception occurs.
     */
     ...
     *
     * @throws TestFailed If a <code>Stub</code> is created from a non-remote interface, or if an unexpected exception
     *                    occurs.
     */
    ...
    /**
     * Ensures that stubs for the same skeleton are equal and have the same hash code, and stubs have a string
     * representation.
     *
