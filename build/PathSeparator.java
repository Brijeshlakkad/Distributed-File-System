 ...
 * platform. To allow the classpath to be set using the <code>-cp</code> option of the <code>java</code> command on both
 * types of systems, the Makefile that is running the command retrieves the separator by running this build tool, and
 * then uses it when issuing the command.
 */
