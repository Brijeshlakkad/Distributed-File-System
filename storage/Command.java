...
public interface Command {
     ...
     *
     * @param file Path to the file to be created. The parent directory will be created if it does not exist. This path
     *             may not be the root directory.
     ...
     *
     * <p>
     * If the file is a directory and cannot be deleted, some, all, or none of its contents may be deleted by this
     * operation.
     *
