 ...
 *
 * <p>
 * This class contains three lists: a list of tests that succeeded, a list of tests that were not run, and a list of
 * reports from tests that failed. Tests not run are so because prerequisite tests did not complete successfully, or
 * were not run at all.
 */
public class SeriesReport implements Serializable {
     ...
     *
     * <p>
     * The test series is considered to have completed successfully if all tests have been run, and no tests failed.
     */
     ...
     *
     * <p>
     * The report includes individual test reports for each failed test, a list of abandoned tests (if any), and a
     * summary.
     *
     * @param stream Stream to receive formatted output.
     */
