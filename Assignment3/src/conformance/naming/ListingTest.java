...
/**
 * Test the naming server <code>list</code> and <code>isDirectory</code> methods.
 *
 * <p>
 * s checked are:
 * <ul>
...
public class ListingTest extends NamingTest {
    ...
    /**
     * Checks that directories are listed correctly, and checks that files and directories are distinguished correctly
     * by <code>isDirectory</code>.
     *
     ...
     *                          made for each child of the directory, in the order they are given in
     *                          <code>expected_children</code>.
     ...
     *
     * @throws TestFailed If any of the methods accept a bad argument, or if the root directory is reported to be a
     *                    file.
     */
