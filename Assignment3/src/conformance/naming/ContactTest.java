 ...
 *
 * <p>
 * This test creates two sockets and attempts to connect to the naming server client service and registration ports. The
 * test succeeds if both connections are accepted.
 */
public class ContactTest extends NamingTest {
     ...
     * @param interface_name The name of the interface to which the connection is being made. This is used for the error
     *                       message in case an exception occurs.
