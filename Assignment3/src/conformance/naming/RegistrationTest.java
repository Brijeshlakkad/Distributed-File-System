...
public class RegistrationTest extends NamingTest {
    ...
    /**
     * Storage server used for the <code>null</code> pointer and duplicate registration tests.
     */
    ...
    /**
     * Performs several registrations that should succeed, and checks that the files chosen by the naming server for
    ...
    private class UnsuccessfulStorageServer extends TestStorageServer {
         ...
         *
         * <p>
         * This method is a replacement for the <code>start</code> method of the storage server.
         *
         * @throws TestFailed If the naming server accepts the second registration.
         */
