 ...
 *
 * <p>
 * This class is provided as an option in case the filesystem is packaged as a single JAR file. In this case, this class
 * provides a single entry point and a convenient way to run any of the utilities provided for accessing the
 * filesystem.
 */
public class Launcher {
     ...
     * Main entry point.
     *
     * @param arguments Command line arguments. The first argument should be the name of the application to be run.
     *                  Following arguments are passed to the application.
     */
