...
public class SkeletonTest extends Test {
     ...
     *
     * <p>
     * This method starts the skeleton and then stops it. In between, it probes to see if the skeleton is accepting
     * connections.
     */
    ...
    /**
     * Ensures that a <code>Skeleton</code> cannot be constructed from a class rather than an interface.
     *
     * @throws TestFailed If a <code>Skeleton</code> is constructed from a class, or if an unexpected exception occurs.
     */
     ...
     *
     * @throws TestFailed If a <code>Skeleton</code> is constructed from a non-remote interface, or if an unexpected
     *                    exception occurs.
     */
     ...
     *
     * @throws TestFailed If <code>null</code> is given as a parameter but the correct exception is not thrown.
     */
     ...
     *
     * <p>
     * Service thread errors are ignored because, in this test, their source is generally the <code>probe</code>
     * method.
     */
