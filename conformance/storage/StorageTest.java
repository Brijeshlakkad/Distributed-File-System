 ...
 *
 * <p>
 * This class takes care of creating a temporary directory for the storage server to serve and starting a test naming
 * server on startup, and removing the directory and stopping the servers on exit.
 */
abstract class StorageTest extends Test {
     ...
     *
     * @param test_files   Files to be created in the storage server root directory.
     * @param delete_files Files the naming server is to command the storage server to delete.
     */
