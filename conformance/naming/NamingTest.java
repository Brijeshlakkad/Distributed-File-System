 ...
 *
 * <p>
 * On initialization, this class starts a naming server and creates stubs for its service and registration interfaces.
 * These objects are then accessible to subclasses of <code>NamingTest</code>.
 *
 * <p>
 * Derived classes should override <code>testServer</code> to include the main test code. Derived classes should
 * override <code>initialize</code> and
...
abstract class NamingTest extends Test {
     ...
     *
     * <p>
     * This method starts the naming server and creates the stubs through which its interfaces can be accessed.
     *
     * @throws TestFailed If the naming server cannot be started, or if the stubs cannot be created.
     */
     ...
     *
     * <p>
     * If a subclass overrides this method, the new implementation should call this method before proceeding to do
     * anything else.
     */
    @Override
