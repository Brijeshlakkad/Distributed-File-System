...
/**
 * Tests that the naming server <code>getStorage</code> method returns the correct storage server stubs.
 *
 * <p>
 * s checked are:
 * <ul>
...
public class StubRetrievalTest extends NamingTest {
     ...
     * @throws TestFailed If the stub cannot be retrieved, or if the stub retrieved is not the stub expected.
     */
